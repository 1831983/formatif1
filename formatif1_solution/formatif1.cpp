...
char AfficherMenu()
{
	...
	ClrScr();
	Gotoxy(15, 4);
	cout << "1- Veuillez Ajouter une activite";
	Gotoxy(15, 6);
	cout << "2- Veuillez  Afficher toutes les activites";
	Gotoxy(15, 8);
	cout << "3- Veuillez  Ajouter des eleves";
	Gotoxy(15, 10);
	cout << "4- Veuillez  Afficher les eleves";
	Gotoxy(15, 12);
	cout << "5- Veuillez Inscrire un eleve a une activite";
	Gotoxy(15, 14);
	cout << "6- Veuillez Afficher les inscriptions d'une activite";
	Gotoxy(15, 16);
	cout << "0- Arreter";
	Gotoxy(15, 18);
	cout << "Choix: ";
